...
import com.createcontactwithbaseclass.JavaUtil;
...
public class ListenersClass extends BaseClass implements ITestListener{
	...
	public void onTestFailure(ITestResult result) {
		...
		String screenshotPath="./screenshot/"+result.getMethod().getMethodName()+"_"+JavaUtil.getSystemDate()+".PNG";
...
//		}
	...
	public void onStart(ITestContext context) {
		//Step1: Configuration
				ExtentSparkReporter htmlReporter=new ExtentSparkReporter("./extentreport"+JavaUtil.getSystemDate()+".html");
